...
import {Result, time, Try } from "../feature/main/mainSlice";
...
if(Time) Time.style.width=`${main.width}%`
     const Operation=()=>{
        let Op:number[]=[];
 ...
 dispatch(Result(output))
    ...
    return ( 
        <div className="grid justify-items-center content-center text-2xl gap-10 h-[100vh] ">
            ...
            <div id="Time" className={`w-[${main.width}%] bg-black h-[4px] rounded-md`} ></div>
            </div>
          ...
          {!main.lose && <>
            <button  style={{boxShadow:'0 4px 8px -2px rgb(0 0 0 / 20%), 0 8px 10px 0 rgb(0 0 0 / 14%), 0 2px 20px 0 rgb(0 0 0 / 12%)'}}
              className={`w-[150px] h-[90px] grid justify-center items-center bg-[#000000e0] text-white border-2 border-solid
            ...
            onClick={()=>{dispatch(Try(main.output.res2[1])); }} >  {main.output.res2[0]}</button>
               ...
               {main.lose && <>
                <button  style={{boxShadow:'0 4px 8px -2px rgb(0 0 0 / 20%), 0 8px 10px 0 rgb(0 0 0 / 14%), 0 2px 20px 0 rgb(0 0 0 / 12%)'}}
              className={`w-[150px] h-[90px] grid justify-center items-center bg-[#000000e0] text-white border-2 border-solid border-black`}> 
               {main.output.res1[0]}</button>
                <button  style={{boxShadow:'0 4px 8px -2px rgb(0 0 0 / 20%), 0 8px 10px 0 rgb(0 0 0 / 14%), 0 2px 20px 0 rgb(0 0 0 / 12%)'}}
              className={`w-[150px] h-[90px] grid justify-center items-center bg-[#000000e0] text-white border-2 border-solid border-black h`} >
                  {main.output.res1[0]}</button>
               </> 
                 }  
         ...
         { main.lose &&  <div className={` p-1 px-2 rounded-md text-center text-lg w-[100px] bg-black text-white cursor-pointer `}
